...
useEffect(() => {
  ...
  const handleMessage = async (pubTopic, messagem) => {
    console.log(messagem.toString());
    console.log(mensage);
    
    
    const res = await ConnApi.post( "/conversas", {"nome": messagem.toString()} )
    console.log(res);
    
    setMensagens(prev => [...prev, messagem.toString()]);
  };
